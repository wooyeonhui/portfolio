    ...
    public function form($aInstance)
    {
        ...
        <ul class="pi_widget_sortable">
            <?php
                ...
                {
                    echo '<p><code>'.__('Click Save button to be able to change the order of tabs', 'wiloke').'</code></p>';
                }
            ...
            <li data-tab="<?php echo esc_attr($tab); ?>">
                <?php
                    echo sprintf( (__('%s', 'wiloke')), esc_html($aInstance[$tab]) );
                    ...
                    <?php
                        foreach ( $aOrder as $key => $tab )
                        {
                            ...
                            <li class="tab-item <?php echo esc_attr($key); ?>">
                                <a data-toggle="tab" href="#<?php echo esc_attr($aIds[$tab]); ?>"><span><?php printf( (__('%s', 'wiloke')), wp_unslash($aInstance[$tab]) ); ?></span></a>
                            </li>
                            <?php
                        }
                    ?>
